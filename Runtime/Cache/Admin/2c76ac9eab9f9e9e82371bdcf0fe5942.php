<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent" style="width:100%">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit" target="dialog"  href="/index.php?s=/Admin/SysMonitor/setting" width="620" height="430" rel="monitorset"><span>监控设置</span></a></li>
			<li><a class="edit" target="navtab" href="/index.php?s=/Admin/SysMonitor/strategy" id="strategy" width="760" height="430" rel="strategy"><span>策略设置</span></a></li>
			<li><a class="edit" target="navtab" href="/index.php?s=/Admin/SysMonitor/strategyBat" id="strategybat" width="760" height="430" rel="strategybat"><span>策略批量设置</span></a></li>
			<li><a class="edit" target="ajaxTodo" href="/index.php?s=/Admin/SysMonitor/showVers" width="300" height="130" rel="show"><span>查看当前版本</span></a></li>
			<li><a class="edit" target="ajaxTodo" href="/index.php?s=/Admin/SysMonitor/toggle"  rel="toggle"><span>切换</span></a></li>					
		</ul>
	</div>
