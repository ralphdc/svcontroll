...
function fleshVerify(type){ 
	...
	if (type){
		$('#verifyImg').attr("src", '/index.php/Log/Public/verify/adv/1/'+timenow);
	}else{
		$('#verifyImg').attr("src", '/index.php/Log/Public/verify/'+timenow);
	}
}
//-->
</script>
...
<div id="login">
	...
	<div class="login_banner">
		<div class="loginForm">
			<form method="post" action="/index.php/Log/Public/checkLogin/">
				<p>
				...
				<p id='p_imgcode'>
					...
					<span><img id="verifyImg" width="90" height="32" SRC="/index.php/Log/Public/verify/" onClick="fleshVerify()" border="0" alt="点击刷新验证码" style="cursor:pointer" align="absmiddle"></span> 
