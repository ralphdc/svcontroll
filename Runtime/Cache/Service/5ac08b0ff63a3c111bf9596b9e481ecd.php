...
<script src="/Public/dwz/js/jplgmonitor.js?v2.3" type="text/javascript"></script>
<div class="container_box" id="container_box">
		<div id="toolContent">
			<div class="panelBar" style="height:33px;">
				<ul class="toolBar">
					...
					<!--
					<li><a  title="确实要删除选中记录吗？" href="javascript:void(0)" class="edit"><span onclick="xgdMoveCenter()">居中显示</span></a></li>
		...
		<div class="rmenue"  id="nodeEditMenu">
			<ul>
				...
				<a href="/index.php/Service/Graphlogic/editNode" width="600" target="dialog" height="500" mask="true" rel="editGraphLGNode">编辑节点</a>
				</li>
		...
		<div class="rmenue"  id="childTPEditMenu">
			<ul>
				<li class="jp_edit">
				<!--  <a href="#" onclick="editChildTP('editChildTP')">编辑子拓扑</a> -->
...
var nodeChild = {
		nodeWidth : 		107,
		nodeHeight:			67,
		nodeChildImage : 	'/Public/Images/jtopolg/childtp.png',
...
$(function(){
	...
	closeA.on('click',function(){
		...
		$.post('/index.php/Service/Graphlogic/clearRedis',{t:dt},function(data){console.log('Redis缓存已清空！');JPStore.clear();})
	}) */
