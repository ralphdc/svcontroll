...
<form method="post" action="/index.php/Service/Operatmember/add" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" novalidate="novalidate">
