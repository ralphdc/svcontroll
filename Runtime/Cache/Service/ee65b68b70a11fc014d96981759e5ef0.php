<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/index.php/Service/Cabinet" method="post">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/index.php/Service/Cabinet" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar" style="height:29px;">
		<ul class="toolBar">
			<li><a rel="findroom" class="add" href="/index.php/Service/Cabinet/add" title="新增" target="dialog" mask="true" height="290" width="443"><span>新增</span></a></li>
			<li><a posttype="string" title="确实要删除选中记录吗？" rel="ids" target="selectedTodo" class="delete" href="/index.php/Service/Cabinet/foreverdelete/id/{sid_user}"><span>批量删除选中</span></a></li>
 ...
 $listnums = $numPerPage * ($currentPage-1) + $key+1; echo $listnums; ?>
				...
				<td><a class="btnDel" target="ajaxTodo" title="确实要删除这条记录吗" href="/index.php/Service/Cabinet/delete/id/<?php echo ($vo['id']); ?>">删除</a><a height="290" width="443" target="dialog" rel="fitting_index1" class="btnEdit" title="编辑" href="/index.php/Service/Cabinet/edit/id/<?php echo ($vo['id']); ?>">编辑</a></td>
