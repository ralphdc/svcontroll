...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/index.php/Service/Graphlogic" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar" style="height:29px;">
		<ul class="toolBar">
			<li><a class="add" href="/index.php/Service/Graphlogic/add" title="新建拓扑图" rel="newLGTopo" target="dialog" max="true" ><span>新增</span></a></li>
			<li><a posttype="string" title="确实要删除选中记录吗？"    class="delete" onclick=" return deleteCookieCheckBoxForLG(this,event)" href="/index.php/Service/Graphlogic/graphBatchDel"><span>批量删除选中</span></a></li>
		...
		<tbody class="currentTbody">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td class="center" style="width: 43px;">
					<div>
						<input type="checkbox" onclick="recordCookieForLG(this)" value="<?php echo ($vo["topoId"]); ?>" name="ids">
					</div>
				</td>
				<td>
				...
				<td><a href="/index.php/Service/Graphlogic/monitor?id=<?php echo ($vo["topoId"]); ?>&start=1" max="true" rel="monitorTP" target="dialog" title="预览拓扑图-<?php echo ($vo["topoName"]); ?>" max="true" rel="topoPreview"><?php echo ($vo["topoName"]); ?></a></td>
				<td><?php echo ($vo["createDate"]); ?></td>
				<td><?php echo ($vo["creator"]); ?></td>
				<td><?php echo ($vo["nodes"]); ?></td>
				<td width="200">
					<a class="btnDel" target="ajaxTodo" callback="delCallback" title="确实要删除这条记录吗" href="/index.php/Service/Graphlogic/graphDel/id/<?php echo ($vo["topoId"]); ?>">删除</a>
					<a height="290" width="443" target="dialog"  class="btnEdit" max="true" title="编辑" rel="editLGGraphWindow" href="/index.php/Service/Graphlogic/edit/id/<?php echo ($vo["topoId"]); ?>">编辑</a>
					<!--
					<a height="290" width="443" target="dialog"  class="btnMonitor" max="true" title="在线监控" href="/index.php/Service/Graphlogic/Monitor/id/<?php echo ($vo["topoId"]); ?>">实时监控</a>
					-->
				</td>
