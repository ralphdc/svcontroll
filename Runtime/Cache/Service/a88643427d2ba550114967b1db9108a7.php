...
<form id="pagerForm" action="/index.php/Service/Sermonitor" method="post">
...
<div class="head_search">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/index.php/Service/Sermonitor" method="post">
	<table>
		<tr>
			<td>
				<label>筛选工具类服务：</label>
			...
			<td>
				<label>IP地址：</label><input type="text" name="ip" id="ip" class="textInput" value="<?php echo ($_REQUEST['ip']); ?>" />
			</td>
			<td>
				<label>服务名称：</label><input type="text" name="serviceName" id="serviceName" class="textInput" value="<?php echo ($_REQUEST['serviceName']); ?>" />
			</td>	
			<td>
...
var sermonitor_server_nodes=[<?php echo ($config_nodes); ?>];
/*
