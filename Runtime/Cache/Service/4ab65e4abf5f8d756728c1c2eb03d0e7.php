...
<script src="/Public/dwz/js/jpmonitor.js?V-2.2.1" type="text/javascript"></script>
<div class="container_box" id="container_box">
	...
	<div class="rmenue"  id="nodeEditMenu">
		<ul>
			<li class="jp_edit">
			<!-- <a href="#" onclick="editNode('editGraphNode')">编辑节点</a>  -->
...
stage.stageDisplayLocation = 0; //是否居中显示；
stage.stageDisplayMode = stageModeDefault; //默认模式；
...
$(function(){
	...
	closeA.on('click',function(){
		...
		$.post('/index.php/Service/Graph/clearRedis',{t:dt},function(data){console.log('Redis缓存已清空！')})
	}) */
