...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="100">
		...
		<tbody id="icontbody">
			...
			<tr>
				<td><?php echo ($i); ?></td>
				<td style="background:url('/Public/Images/jtopo/<?php echo ($vo); ?>') no-repeat center; height:100px;"></td>
				<td>
					<a class="btnSelect" title="查找带回" href="javascript:$.bringBack({'imgName':'<?php echo $vo; ?>'})">选择</a>
					<a class="btnDel" callback="reflashIcon" title="确实要删除这条记录吗" target="ajaxTodo" href="/index.php/Service/DeviceType/delicon/icon/<?php echo (geticonname($vo)); ?>">删除</a> 
...
<script type="text/javascript">
	   $("#file_upload_icon_device").uploadify({
		        ...
		        'uploader'			: '/index.php/Service/DeviceType/icon',
		         'formData'			: {
		        	'act':'upload',
		        	'js_source':'uploadify',
		        ...
		        'onUploadSuccess' 	: function(file, data, response) {
		        	...
		        	if(rs.statusCode == 1){
		        		/* var tmp = "<tr>";
		        			...
		        			tmp += "<td width='80'><a class='btnSelect' title='查找带回' href='javascript:void(0)' onclick='takeback(\""+rs.image+"\")'>选择</a><a class='btnDel' callback='reflashIcon' title='确实要删除这条记录吗' target='ajaxTodo' href='/index.php/Service/DeviceType/delicon/icon/"+imageN+"'>删除</a></td>";
		        			tmp += "</tr>";
		        			$("#icontbody").prepend(tmp); */
		        		$.pdialog.reload('/index.php/Service/DeviceType/icon/');
