...
<script type="text/javascript">
	...
	var operate_nodes = [<?php echo ($operate_tree); ?>];
...
function zTreeOnClick(event, treeId, treeNode){
	...
	if(treeNode.level == 2){
		...
		$("#config_content_operate").loadUrl('/index.php/Service/Operatmember/showNoticeWay?noticetype='+nt+'&gid='+gpid+'&oid='+oid+'&oname='+nm);
	}
}
