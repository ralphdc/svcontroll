...
<script src="/Public/dwz/js/jplgmonitor.js?v2.4" type="text/javascript"></script>
<div class="container_box" id="container_box">
	...
	<?php
 $last = $trace[count($trace)-2]; $lastid = $last[0]; ?>
	 <div class="formBar">
...
<input type="hidden" name="TpId" class="TpId"  value="<?php echo ($tpid); ?>" />
