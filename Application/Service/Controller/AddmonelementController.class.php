...
class AddmonelementController extends CommonController {
	//var $navTab = 'D60610';
	var $navTab = '2c948cfb51ec5db00151ec90fa0d001d';
...
// 框架首页
	...
	public function savepersons()
	{
		if($_POST){
			...
			{
			    $type = '';
			    $child_type_wc     = in_array('wechat',$noticetypeArr) ? '1' :'0';
			    $child_type_email  = in_array('email',$noticetypeArr)  ? '1' :'0';
			    $child_type_msg    = in_array('msg',$noticetypeArr)  ? '1' :'0';
			    $type = $child_type_wc.$child_type_email.$child_type_msg;
			    	
			    $type= bindec(strval($type));
		...
		$rightInt = decbin(intval($info['type']));
