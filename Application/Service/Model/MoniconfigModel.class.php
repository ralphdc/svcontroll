<?php
/**
 * 服务管服务和java通信公共数据接口类子类（元素资源类型）
 * @author zengguangqiu
 *
 */
class MoniconfigModel extends CommunicationModel {
	var $method = array(
			'index'=>'monitor.elem.restype.search',
			'add'=>'monitor.elem.restype.create',
			'update'=>'monitor.elem.restype.update',
			'delete'=>'monitor.elem.restype.deletebatch',
			'deleteall'=>'monitor.elem.restype.deletebatch',
			'getrow'=>'monitor.elem.restype.get',
			'getall'=>'monitor.elem.restype.load',
	);
