...
// 		dump($str);
	...
	function request_by_other_v2($array)
	{
	    Think\Log::write("////////////////////////////// 传入的发送参数是： ".print_r($array,true));
	    ...
	    $data = file_get_contents(C('SERVICE_JAVA_NEW_NAME').$array['path'], false, $stream_context);
	    Think\Log::write("//////////////////////////////request_by_other_v2 Request-Url is".print_r(C('SERVICE_JAVA_NEW_NAME').$array['path'],true));
	    Think\Log::write("//////////////////////////////request_by_other_v2 context data is".print_r($context,true));
        Think\Log::write("//////////////////////////////request_by_other_v2 file_get_contents data is".$data);
	    return $data;
	}
}