<?php
/**
 * 服务管服务和java通信公共数据接口类子类（机柜）
 * @author zengguangqiu
 *
 */
class CabinetModel extends CommunicationModel {
	var $server = '/omp/asset';
	var $method = array(
			'index'=>'asset.cabinet.search',
			'add'=>'asset.cabinet.create',
			'update'=>'asset.cabinet.update',
			'delete'=>'asset.cabinet.delete',
			'deleteall'=>'asset.cabinet.deletebatch',
			'getrow'=>'asset.cabinet.get',
			'getall'=>'asset.cabinet.list',
	);
