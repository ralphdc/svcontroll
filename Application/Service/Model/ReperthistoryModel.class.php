<?php
/**
 * 服务管服务和java通信公共数据接口类子类（仓库中心历史记录）
 * @author zengguangqiu
 *
 */
class ReperthistoryModel extends CommunicationModel {
	var $method = array(
			'index'=>'repertory.history.search',
