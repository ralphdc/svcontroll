...
body{ 
	background: #fff; font-family: '微软雅黑'; color: #333; font-size: 16px; 
}
img{ 
	border: 0; 
}
...
.face{ 
	font-size: 100px; font-weight: normal; line-height: 120px; margin-bottom: 12px; 
}
h1{ 
