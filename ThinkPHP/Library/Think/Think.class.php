...
class Think {
    ...
    static public function start() {
      ...
      set_exception_handler('Think\Think::appExceptionForDwz');
     ...
     * @param mixed $e 异常对象
     */
    static public function appExceptionForDwz($e) {
        $error = array();
        $error['message']   =   $e->getMessage();
        $trace              =   $e->getTrace();
        if('E'==$trace[0]['function']) {
        ...
        //self::halt($error);
        //return $error['message'];
        $ret = array("statusCode"=>0,"message"=>$error['message'],"navTabId"=>"",//$this->navTab
