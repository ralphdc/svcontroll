...
function(window) {
	function Element() {
		this.initialize = function() {
			...
			this.serializedProperties = ["_id","elementType"], 
			this.propertiesStack = [], 
			this._id = "" + (new Date).getTime(),
			this.xgdid = ""; //对画布上的节点进行唯一标识；
			this.dtype = ""; //为了区别正常子节点和拓扑图子节点，添加标识符；
			
			this.nodeSetInfo = {};
			this.linkSetInfo = {};
			//Stage专用，记录状态；
			this.stageDisplayLocation = "";
			this.stageDisplayMode = "";
			//2016-03-18 增加服务器的serverid值；
			this.serverid = "";
			this.serviceName = "";
			this.tpid = "";
	...
	function b() {
		...
		}, this.getXgdId = function() {
			return {
				xgdid: this.xgdid
			}
		}, this.setXgdId = function(id) {
			return this.xgdid = id, this
		},this.getServerId = function() {
			return {
				serverid: this.serverid
			}
		}, this.setServerId = function(id) {
			return this.serverid = id, this
		},this.getServiceName = function() {
			return {
				serviceName: this.serviceName
			}
		}, this.setServiceName = function(name) {
			return this.serviceName = name, this
		},this.getTpId = function() {
			return {
				tpid: this.tpid
			}
		}, this.setTpId = function(id) {
			return this.tpid = id, this
		}, this.getProName = function() {
			return {
				proName: this.proName
			}
		}, this.setProName = function(name) {
			return this.proName = name, this
		},this.getDtype = function() {
			return {
				dtype: this.dtype
			}
		}, this.setDtype = function(dtype) {
			return this.dtype = dtype, this
		}, this.getBound = function() {
			return {
				left: this.x,
				top: this.y,
