...
class DeviceInfoController extends CommonController {
    //var $navTab = 'D60629';
    var $navTab = '2c948cfb51ec5db00151ec9c2a49003b';
	...
	function leading()
	{
	    if(I('post.act','','htmlspecialchars,trim') == 'upload'){
	        ...
	        echo json_encode($ret);	return;
	            ...
	            $url = 'http://'.$_SERVER['HTTP_HOST'].'/Uploads/'.$info['Filedata']['savepath'].$info['Filedata']['savename'];
