 ...
 *
 */
class MonitorfilterModel extends CommunicationModel {
	var $method = array(
			'index'=>'monitor.filter.search',
			'add'=>'monitor.filter.create',
			'update'=>'monitor.filter.update',
			'delete'=>'monitor.filter.deletebatch',
			'deleteall'=>'monitor.filter.deletebatch',
			'getrow'=>'monitor.filter.get',
	);
