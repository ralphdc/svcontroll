 ...
 *
 */
class PartitionmanageModel extends CommunicationModel {
	var $method = array(
			'index'=>'asset.operatesystem.search',
			'add'=>'asset.area.create',
			'update'=>'asset.area.update',
			'delete'=>'asset.area.delete',
			'deleteall'=>'asset.area.deletebatch',
			'getrow'=>'asset.area.list',//(缺少)
			'getall'=>'asset.area.list',
	);
