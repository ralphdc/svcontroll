<?php
/**
 * 日志服务和java通信公共数据接口类子类（分析规则）
 * @author zengguangqiu
 *
 */
class AnalysisRuleModel extends CommunicationModel {
	var $method = array(
			'index'=>'xgd.log.setting.tnlist',
			'add'=>'xgd.log.setting.tnadd',
			'update'=>'xgd.log.setting.tnedit',
			'delete'=>'xgd.log.setting.tndelete',
			'deleteall'=>'xgd.log.setting.tndelete',
			'getrow'=>'xgd.log.setting.tnget',
			'getall'=>'xgd.log.setting.tnlistall',
	);
